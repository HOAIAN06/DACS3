...
fun OrderHistoryScreen(
    ...
    Scaffold(
        topBar = {
            TopAppBar(
                title = { Text("L?ch s? don hàng", fontWeight = FontWeight.ExtraBold) },
                navigationIcon = {
        ...
        Column(modifier = Modifier.padding(16.dp), verticalArrangement = Arrangement.spacedBy(10.dp)) {
            Row(
                ...
                Column(verticalArrangement = Arrangement.spacedBy(4.dp)) {
                    Text(
                        text = order.orderCode.ifBlank { "Không có mã don" },
            ...
            Text(
                text = order.itemPreview.ifBlank { "Ðon giao hàng" },
                fontSize = 14.sp,
                color = PrimaryBlack,
    ...
    Column(
        ...
        Surface(
            ...
            Column(
                ...
                Text("B?n chua có don hàng nào", fontWeight = FontWeight.Bold, fontSize = 18.sp)
                Text("Th?c hi?n don hàng d?u tiên ngay thôi!", color = TextSecondary, fontSize = 14.sp)
            }
        }
